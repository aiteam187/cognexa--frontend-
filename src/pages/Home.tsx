...
function Home() {
  return (
    <>
      ...
      {/* aiAnalytics — Advanced email understanding (peach bg) */}
      <section id="aiAnalytics" className="bg-[#fdf2e9] py-20">
        <div className="mx-auto max-w-[1400px] px-5">
          <Reveal className="mx-auto max-w-2xl text-center">
            <span className="inline-block rounded-full bg-[#0E8FFB]/10 px-4 py-1.5 text-sm font-semibold tracking-wide text-[#0E8FFB] uppercase">
              Email Automation
          ...
          <div className="mt-8 flex flex-wrap items-center gap-14">
            <Reveal className="flex-1 basis-100">
              ...
              <p className="mt-3 text-gray-500">
                Powered by LLMs, Cognexa Email Automation comprehends complex
                mail written in everyday language
              </p>
              <ul className="mt-5 space-y-2.5">
                <CheckItem>Understands long, unstructured mails</CheckItem>
                <CheckItem>Identifies multiple intents in the email</CheckItem>
                <CheckItem>Recognizes urgency and user sentiment</CheckItem>
              </ul>
            </Reveal>
            <Reveal delay={120} className="hover-lift flex-1 basis-100">
              <AIGradientBorder className="rounded-2xl" tone="brand">
                <img
          ...
          <div className="mt-16 flex flex-wrap items-center gap-14">
            <Reveal className="hover-lift order-2 flex-1 basis-100 md:order-1">
              <AIGradientBorder className="rounded-2xl" tone="brand">
                <img
                  src={emailSetupImg}
            ...
            <Reveal delay={120} className="order-1 flex-1 basis-100 md:order-2">
              <h3 className="text-2xl font-bold text-gray-900">
                Achieve faster time to value with quick setup.
              </h3>
              <p className="mt-3 text-gray-500">
                Design email AI agents effortlessly in minutes with our
                intuitive AI co-pilot. Go to market faster with ready-to-deploy
                single-click integrations available for all leading contact
                centers, help desks, and CRM systems.
              </p>
              <ul className="mt-5 space-y-2.5">
                <CheckItem>
                  Refer knowledge base for relevant resolutions
                </CheckItem>
                <CheckItem>Escalate to the right team</CheckItem>
      ...
      {/* aiChat — Consistent Brand Voice (peach bg) */}
      <section id="aiChat" className="bg-[#fdf2e9] py-20">
        <div className="mx-auto max-w-[1400px] px-5">
          <Reveal className="mx-auto max-w-2xl text-center">
            <span className="inline-block rounded-full bg-[#0E8FFB]/10 px-4 py-1.5 text-sm font-semibold tracking-wide text-[#0E8FFB] uppercase">
              Helpdesk &amp; Support
            ...
            <h2 className="mt-4 text-3xl font-bold text-gray-900 sm:text-4xl">
              Consistent Brand Voice, Accelerated Growth.
            </h2>
            <p className="mt-4 text-gray-500">
              Deliver the same helpful, on-brand experience across every support
              touchpoint, from the first chat message to the final resolution.
            </p>
          </Reveal>
          ...
          <div className="mt-16 flex flex-wrap items-center gap-14">
            ...
            <Reveal delay={120} className="flex-1 basis-100">
              <h3 className="text-2xl font-bold text-gray-900">
                Superpower your agents with a contextual and intuitive helpdesk
              </h3>
              <p className="mt-3 text-gray-500">
                Customers expect personalized and contextually relevant
                interactions when they interact with support AI agents. By
                accessing details of previous issues or tickets across channels,
                AI agents get enough context to have contextual
                conversations with customers.
              </p>
              <ul className="mt-5 space-y-3">
                <CheckItem>
                  Efficiently address recurring customer inquiries with
                  Cognexa's dynamic AI agents, enabling up to 80% of questions
                  to be resolved through self-service.
                </CheckItem>
                <CheckItem>
                  Save an agent's time by automating FAQs in minutes using
                  Cognexa's DocCog feature and respond to customers instantly.
                </CheckItem>
                <CheckItem>
                  Enable agents to handle complex requests by converting bot
                  conversations directly into tickets on Freshdesk.
                </CheckItem>
              </ul>
            </Reveal>
          </div>
          ...
          <div className="mt-16 flex flex-wrap items-center gap-14">
            <Reveal className="order-2 flex-1 basis-100 md:order-1">
              <h3 className="text-2xl font-bold text-gray-900">
                Streamline IT support to improve employee experience.
              </h3>
              <p className="mt-3 text-gray-500">
                Design IT support AI agents effortlessly in minutes with our
                intuitive AI co-pilot. Go to market faster with ready-to-deploy
                single-click integrations available for all leading contact
                centers, help desks, and CRM systems.
              </p>
              <ul className="mt-5 space-y-3">
                <CheckItem>
                  Convert bot conversations into incident tickets on
                  Freshservice to track issues and requests.
                </CheckItem>
                <CheckItem>
                  Enable self-service by providing an enriched employee
                  knowledge base on Freshservice and provide employees with
                  quick access to relevant information with Cognexa's DocCog.
                </CheckItem>
                <CheckItem>
                  Intelligently escalate urgent and complex requests as a ticket
                  to a support agent or a team within Freshservice.
                </CheckItem>
              </ul>
            </Reveal>
            <Reveal
